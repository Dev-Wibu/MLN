      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Card className="mb-12 border-amber-200">
          <CardHeader className="bg-gradient-to-r from-amber-100 to-yellow-100">
            <CardTitle className="text-2xl text-amber-900 text-center">So sánh: Xã hội truyền thống vs. Xã hội số</CardTitle>
          </CardHeader>
        ...
        <Card className="mb-12 border-amber-200">
          <CardHeader className="bg-gradient-to-r from-yellow-100 to-orange-100">
            <CardTitle className="text-2xl text-amber-900 text-center">Lịch sử các hình thức bóc lột</CardTitle>
          </CardHeader>
          <CardContent className="p-6">
